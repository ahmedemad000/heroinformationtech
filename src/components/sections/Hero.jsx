        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              ...
              <br />
              <span className="text-neutral-dark">Transformation</span>
              <br />
              <span className="text-neutral-gray">Partners</span>
            </h1>
            
            <motion.p 
              className="text-xl text-neutral-gray mb-8 leading-relaxed"
